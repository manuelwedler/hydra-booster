...
The config uses the latest `manuelwedler/hydra-booster` image, so if you've tagged and pushed a new version all you need to do is scale down and up each deployment:
